    ...
    def compile_core(self, script):
        ...
        for line in tqdm(split_script):
            ...
            if tokens[0] == "alloc_ds":
                ...
                """
                self.s_out += "-1 " + "core_var_"+tokens[1] + " ?\n"
            elif tokens[0] == "out":
                """
                > out var
                prints the value of variable var
                """
                self.s_out += "core_var_"+tokens[1] + " -1 ?\n"
            elif tokens[0] == "sub":
                """
                ...
                """
                if len(tokens) == 3:
                    self.s_out += "core_var_"+tokens[1] + " " + "core_var_"+tokens[2] + " ?\n"
                if len(tokens) == 4:
                    self.s_out += "tmp tmp ?\n"
                    self.s_out += "core_var_"+tokens[3] + " " + "core_var_"+tokens[3] + " ?\n"
                    self.s_out += "core_var_"+tokens[2] + " tmp ?\n"
                    self.s_out += "core_var_"+tokens[1] + " " + "core_var_"+tokens[3] + " ?\n"
                    self.s_out += "tmp " + "core_var_"+tokens[3] + " ?\n"
                ...
                if len(tokens) == 3:
                    self.s_out += "tmp tmp ?\n"
                    self.s_out += "core_var_"+tokens[1] + " tmp ?\n"
                    self.s_out += "tmp " + "core_var_"+tokens[2] + " ?\n"
                ...
                """
                self.s_out += "core_var_"+tokens[1] + " " + "core_var_"+tokens[1] + " ?\n"
            elif tokens[0] == "label":
                """
                > label jmp_pos
                ...
                """
                self.s_out += "core_label_"+tokens[1] + ":0 0 ?\n"
            elif tokens[0] == "jmp":
                """
                > jmp jmp_pos
                jump to label jmp_pos
                """
                self.s_out += "0 0 " + "core_label_"+tokens[1] + "\n"
            elif tokens[0] == "cpy":
                """
                > cpy var_a var_b
                ...
                """
                self.s_out += "tmp tmp ?\n"
                self.s_out += "core_var_"+tokens[2] + " " + "core_var_"+tokens[2] + " ?\n"
                self.s_out += "core_var_"+tokens[1] + " tmp ?\n"
                self.s_out += "tmp " + "core_var_"+tokens[2] + " ?\n"
            elif tokens[0] == "mv":
                """
                ...
                self.s_out += "core_var_"+tokens[1] + " tmp_2 ?\n"
                self.label_count += 1
                ...
                self.s_out += "core_var_"+tokens[1] + ":0 0 0\n"
                ...
                self.s_out += "0 "+ "core_var_"+tokens[1]+" ?\n"
                self.s_out += "?-3 tmp ?\n"
                self.s_out += "core_var_"+tokens[2] + " tmp ?\n"
                ...
                self.s_out += "set_op_clear_a_" + str(self.label_count) + ":0 set_op_clear_b_" + str(
                    self.label_count) + ":0 ?\n"
                self.s_out += "core_var_"+tokens[3]+" tmp ?\n"
                ...
                """
                self.s_out+= "core_var_"+tokens[3] + " "+ "core_var_"+tokens[3] + " ?\n"
                self.s_out+= "min_one "+"core_var_"+tokens[3]+ " ?\n"
                self.s_out += "tmp tmp ?\n"
                self.s_out += "tmp_2 tmp_2 ?\n"
                self.s_out += "core_var_"+tokens[1] + " tmp ?\n"
                self.s_out += "core_var_"+tokens[2] + " tmp_2 ?\n"
                self.s_out += "tmp tmp_2 ?+3\n"
                self.s_out += "one "+"core_var_"+tokens[3]+" ?\n"
...
if __name__ == '__main__':
    ...
    #                   "inp a\nadd a b\nout b\nadd a b c\nout c\nclr a\nclr b\nclr c")
    with open("scripts/hello_world.s", "r") as file:
